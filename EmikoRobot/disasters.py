...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        message.reply_text("This member is already a Jonin")
        return ""
    ...
    update.effective_message.reply_text(
        rt
        + "\nSuccessfully raised {} to Jonin!".format(
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        rt += "This member is a Jonin, Demoting to Soldier."
        data["sudos"].remove(user_id)
        DRAGONS.remove(user_id)
...
def sudolist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Member of Jonin Clan😈:</b>\n"
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Member of Sannin Clan😈:</b>\n"
...
IGNITE_HANDLER = CommandHandler(
    ["memberlist", "ignite family"], memberlist, run_async=True
) 
